...
| 3회차 | 작성됨 | AI에게 디자인 수정과 요구사항을 정확히 전달하기 | 스크린샷 기반 수정, Codex Browser 주석, DESIGN.md 레퍼런스 토큰, 원하는 요소만 적용, 모바일 확인 | [sessions/03](./sessions/03/) |
...
- 목표: 스크린샷, Codex Browser 주석, DESIGN.md 레퍼런스 토큰을 기준으로 원하는 요소만 골라 디자인 수정 요청하기
